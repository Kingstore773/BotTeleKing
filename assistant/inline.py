...
≽ <b>Pʏ-wafa Vᴇʀsɪᴏɴ :</b> <code>{__version__}</code>
≽ <b>wafa Vᴇʀsɪᴏɴ :</b> <code>{ayiin_ver}</code> [{HOSTED_ON}]
╰✠╼━━━━━━━━━━━━━━━✠╯
    '''
    return output
